...
FB.education._onGenerateClick = function (bookId) {
  ...
  if (!apiKey) {
    ...
    statusEl.innerHTML =
      ...
      '<input id="edu-api-key-input" type="password" placeholder="[REDACTED_ANTHROPIC_API_KEY]" style="flex:1;padding:10px;background:#0f0f0f;border:1px solid #444;border-radius:6px;color:#fff;font-size:12px">' +
